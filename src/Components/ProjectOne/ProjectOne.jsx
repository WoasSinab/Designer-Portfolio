const ProjectOne = () => {
  return (
    // Project one 1
    <div className='flex lg:flex-row flex-col-reverse bg-one mx-2 my-8 rounded-2xl text-black/90'>
      {/* Contents  */}
      <div className='lg:w-1/2 flex flex-col justify-between w-full'>
        ...
        <div className='m-6'>
          <p className='leading-loose lg:pr-32'>At our design agency, we pride ourselves on crafting exceptional User Interface (UI) and User Experience (UX) designs for e-commerce websites. Our team understands the critical role that design plays in creating a seamless and delightful shopping experience for users.</p>
      ...
      {/* img  */}
      <div className='lg:w-1/2 flex lg:justify-end w-full'>
