  ...
  return (
    <div className='flex flex-col md:flex-row mx-2 my-4 text-white justify-between gap-4 md:gap-0'>
      ...
      <div className='md:w-1/2 w-full bg-gradient-to-tr from-indigo-800 to-violet-900 rounded-md md:mr-4'>
        <h1 className='leading-relaxed font-semibold text-2xl md:text-3xl m-6 my-8 '>User Experience (<span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-bold'
        ">UX</span>) Design</h1>
      ...
      <div className='md:w-1/2 w-full bg-gradient-to-tr from-indigo-900 to-violet-900 rounded-md md:ml-4'>
        <h1 className='leading-relaxed font-semibold text-2xl md:text-3xl m-6 my-8'>User Interface (<span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-bold'
        ">UI</span>) Design</h1>
